...
public abstract class FramebufferShader extends Shader
{
    ...
    public FramebufferShader(final String fragmentShader) {
        ...
        this.alpha = Float.intBitsToFloat(Float.floatToIntBits(14.2064905f) ^ 0x7EE34DC9);
        this.radius = Float.intBitsToFloat(Float.floatToIntBits(0.8626796f) ^ 0x7F5CD892);
        this.quality = Float.intBitsToFloat(Float.floatToIntBits(15.053767f) ^ 0x7EF0DC3B);
    }
