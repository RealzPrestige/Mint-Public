...
public class BlueSpaceShader extends FramebufferShader {
    public static BlueSpaceShader BLUE_SPACE_SHADER;
    public float time;

    public BlueSpaceShader() {
        super("bluespace.frag");
    }
    ...
    static {
        BlueSpaceShader.BLUE_SPACE_SHADER = new BlueSpaceShader();
    }
}
